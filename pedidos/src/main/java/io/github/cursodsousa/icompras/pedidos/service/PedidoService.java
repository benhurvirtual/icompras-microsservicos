...
public class PedidoService {
    ...
    public void atualizarStatusPagamento(
       ...
       var pedidoEncontrado = repository
         ...
         if(pedidoEncontrado.isEmpty()){
             var msg = String.format("Pedido com código %d e chave de pagamento %s não encontrado",
    ...
    public void adicionarNovoPagamento(
        ...
        if (pedidoEncontrado.isEmpty()){
            throw new ItemNaoEncontradoException("Pedido com código %d não encontrado".formatted(codigoPedido));
        }
